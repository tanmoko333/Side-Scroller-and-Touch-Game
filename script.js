window.addEventListener("load", function() {
    ...
    let score = 0;
    let gameOver = false;
    const fullScreeButton = document.getElementById("fullScreenButton");
    ...
    function displayStatusText(context) {
        ...
        if (gameOver) {
            ...
            context.fillStyle = "black";
            context.fillText("GAME OVER! Please Enter or Swipe Down to Restart", canvas.width/2, 200);
            context.fillStyle = "white";
            context.fillText("GAME OVER! Please Enter or Swipe Down to Restart", canvas.width/2, 202);
        }
    }
